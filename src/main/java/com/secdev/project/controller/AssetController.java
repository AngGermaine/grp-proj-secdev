...
public class AssetController {
    ...
    public String addAsset(@Valid @ModelAttribute AssetRequest request,
        ...
        if (bindingResult.hasErrors()) {
            redirectAttributes.addFlashAttribute("error", "Invalid asset input");
    ...
    public String editAsset(@PathVariable Long id,
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute("error", "You are not allowed to edit this asset");
        } catch (Exception e) {
    ...
    public String deleteOwnAsset(@PathVariable Long id,
                                 RedirectAttributes redirectAttributes) {
        try {
            assetService.deleteOwnAsset(id, getCurrentUsername());
            redirectAttributes.addFlashAttribute("success", "Asset deleted successfully");
        } catch (AccessDeniedException e) {
            redirectAttributes.addFlashAttribute("error", "You are not allowed to delete this asset");
        } catch (Exception e) {
